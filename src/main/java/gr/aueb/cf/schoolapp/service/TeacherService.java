...
//    }
    ...
    public TeacherReadOnlyDTO deletedTeacherByUUID(UUID uuid) throws EntityNotFoundException {
        try {
...
//            teacherRepository.save(teacher);
    ...
    @PreAuthorize("hasAuthority('EDIT_TEACHER')")
    @Transactional(readOnly = true)
    public TeacherEditDTO getTeacherByUUIDAndDeletedFalse(UUID uuid) throws EntityNotFoundException {
